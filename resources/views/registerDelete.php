        ...
        <div class="home-header">
            <div class="home-header-wrapper">
                <div class="order-operation-wrap">
                    <a href="" class="btn btn-primary">Ordenar por reserva</a>
                </div>
                    ...
                    <div class="search-container">
                        <form action="/buscar" method="GET">
                            ...
                            <select name="criteria" required>
                                ...
                                <option value="ownerNameReservation">Nombre del Propietario</option>
                                <option value="ownerSurnameReservation">Apellido del Propietario</option>
                ...
                <a class="row-a" href="">
                    <table>
                        <tr>
                            ...
                            <th>
                                <form action="/deleteRegister/<?= $reservation['id'] ?>" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta reserva?');">
                                    <!-- Campo CSRF obligatorio para formularios en Laravel -->
                                    <input type="hidden" name="_token" value="<?= csrf_token() ?>">
                                    <!-- Campo para especificar el método DELETE -->
                                    <input type="hidden" name="_method" value="DELETE">
                                    <button type="submit" class="btn-info">Borrar</button>
                                </form>
                            </th>
                        </tr>
                    </table>
